...
/**
 * The request type for {@link CatalogClient.getEntitiesByRef}.
 *
 * @public
 */
export interface GetEntitiesByRefRequest {
  /**
...
/**
 * The response type for {@link CatalogClient.getEntitiesByRef}.
 *
 * @public
 */
export interface GetEntitiesByRefResponse {
  /**
